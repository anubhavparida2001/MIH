...
if (isset($_POST['Next'])) {
    ...
    if (empty($_POST['DOB'])) {
        ...
        $pagecheck = 20;
        $update_data = "UPDATE usertable SET DOB ='$DOB', R = '$R', MT='$MT', C='$C', WTM='$WTM', SC='$SC', DOSH='$DOSH', pagecheck = '$pagecheck'  WHERE email ='$email'";
...
if (isset($_POST['continue'])) {
    ...
    $FT = mysqli_real_escape_string($con, $_POST['FT']);
    $FV = mysqli_real_escape_string($con, $_POST['FV']);
    $update_h = "UPDATE usertable SET Height ='$Height', MS = '$MS', AD='$AD', FS='$FS', FT='$FT', FV='$FV', pagecheck = '$pagecheck' WHERE email ='$email'";
...
if (isset($_POST['continue2'])) {
    ...
    $pagecheck = 80;
    $About = mysqli_real_escape_string($con, $_POST['About']);
    $update_h = "UPDATE usertable SET About ='$About', pagecheck = '$pagecheck' WHERE email ='$email'";
    $data_check = mysqli_query($con, $update_h);
    if ($data_check) {
...
if (isset($_POST['continue1'])) {
    ...
    $WL = mysqli_real_escape_string($con, $_POST['WL']);
    $RS = mysqli_real_escape_string($con, $_POST['RS']);
    $update_h = "UPDATE usertable SET ED ='$ED', EI = '$EI', AI='$AI', OCC='$OCC', WL='$WL', RS='$RS', pagecheck = '$pagecheck' WHERE email ='$email'";
    $data_check = mysqli_query($con, $update_h);
    if ($data_check) {
