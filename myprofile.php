...
<body>
    ...
    <section class="home-section">
        ...
        <div class="test">
            ...
            echo "Partner's Age : " . $row['Age'] . "<br><br>";
            echo "Partner's Height : " . $row['PHT'] . "<br><br>";
            echo "Partner's Marital Status : " . $row['PMS'] . "<br><br>";
            echo "Partner's Mother Tongue : " . $row['PMT'] . "<br><br>";
            echo "Partner's Physical Status : " . $row['PPS'] . "<br><br>";
            echo "Partner's Education : " . $row['PED'] . "<br><br>";
            echo "Partner's Employed Sector : " . $row['PEI'] . "<br><br>";
            echo "Partner's Occupation : " . $row['POCC'] . "<br><br>";
            echo "Partner's Annual Income : " . $row['PAI'] . "<br><br>";
            echo "Partner's Cast : " . $row['PC'] . "<br><br>";
            echo "Partner's Extra Preferance : " . $row['PEX'] . "<br><br>";
            ?>

            <br><br>
            See some Recomendation <a href="findmatch.php">Click Here</a>
        </div>
    </section>
